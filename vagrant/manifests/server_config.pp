...
class server_config {
  file { 'apache2.config':
    ...
    source  => '/vagrant/vagrant/resources/app/etc/apache2/sites-available/default',
  ...
  file { 'php5.config':
    ...
    source  => '/vagrant/vagrant/resources/app/etc/php5/apache2/php.ini',
    require => Package['apache2']
  }
  ...
  file { 'mcrypt.config':
    ...
    source  => '/vagrant/vagrant/resources/app/etc/php5/conf.d/mcrypt.ini',
    require => Package['apache2']
  }
